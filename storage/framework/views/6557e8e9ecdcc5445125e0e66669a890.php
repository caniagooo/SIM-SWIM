                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="fw-semibold text-gray-800"><?php echo e($student->birth_date); ?></div>
                                        <div class="text-gray-500 fs-8"><?php echo e(\Carbon\Carbon::parse($student->birth_date)->age); ?> tahun</div>
                                    </td>
                                    <!-- Kelompok Usia -->
                                    <td class="text-center">
