    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded-3 shadow-sm">
            <div class="modal-header bg-light-info border-0 pb-2">
                <h5 class="modal-title fw-bold" id="sessionsModalLabel-<?php echo e($course->id); ?>">
                    <div><i class="bi bi-calendar-event me-2 text-info"></i>
                    Jadwal Sesi
                    </div>
                    <div><span class="text-dark fs-8"><?php echo e($course->name); ?></span>
                    <span class="text-dark">
                        <a href="<?php echo e(route('courses.show', $course->id)); ?>" class="bi-eye ms-1 text-decoration-none text-dark" title="Lihat Detail Kursus">
            ...
            <div class="modal-body py-3 px-2">
                ...
                <div class="d-flex flex-wrap px-5 gap-2 mb-3 justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="small">
                            <?php echo e($course->start_date ? \Carbon\Carbon::parse($course->start_date)->translatedFormat('d F Y') : '-'); ?>

                            -
                            <?php echo e($course->valid_until ? \Carbon\Carbon::parse($course->valid_until)->translatedFormat('d F Y') : '-'); ?>

                        </span></span></span>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <i class="bi bi-geo-alt-fill text-danger fs-5"></i>
                        <span class="small"><?php echo e($course->venue->name ?? '-'); ?></span>
                    </div>
                </div>
                <!-- Tabel Sesi -->
                <?php
                        ...
                        <table class="table table-sm align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-center text-gray-600 fw-bold"><?php echo e($idx+1); ?></td>
                                        ...
                                        <td>
                                            <span class="badge 
                                                ...
                                                <?php elseif($session->status === 'scheduled'): ?> badge-light-info
...
</div><?php /**PATH C:\Users\JITU\swim\resources\views\courses\partials\sessions-modal.blade.php ENDPATH**/ ?>