        ...
        <tbody>
            <?php $__currentLoopData = $session->students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e(ucfirst($student->attendance_status ?? 'Not Set')); ?></td>
                </tr>
...
<div class="mt-5">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            <?php $__currentLoopData = $session->trainers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($loop->iteration); ?></td>
                    <td><?php echo e($trainer->trainer->name); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    </table>
...
<?php endif; ?><?php /**PATH C:\Users\JITU\swim\resources\views\sessions\show.blade.php ENDPATH**/ ?>