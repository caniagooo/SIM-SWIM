...
<?php $component->withAttributes([]); ?>
    <div class="container">
        ...
        <div class="d-flex flex-wrap flex-stack align-items-center mb-5 gap-3 gap-md-0">
            <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center flex-wrap flex-grow-1 gap-2">
                ...
                <div class="dropdown mb-2 mb-md-0">
                    <button class="btn btn-light-primary btn-sm dropdown-toggle d-flex align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <span class="badge <?php echo e($statusBadgeClass); ?> ms-2"><?php echo e($statusCount); ?></span>
                    </button>
                        ...
                        <li>
                            <a class="dropdown-item d-flex justify-content-between align-items-center status-filter-link <?php echo e(!request('status') ? 'active fw-bold' : ''); ?>"
                               href="<?php echo e(route('courses.index', request()->except('status'))); ?>">
                                Total
                                <span class="badge bg-primary text-white ms-2"><?php echo e($countTotal); ?></span>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex justify-content-between align-items-center status-filter-link <?php echo e(request('status') == 'active' ? 'active fw-bold' : ''); ?>"
                               href="?status=active">
                                Aktif
                                <span class="badge bg-success text-white ms-2"><?php echo e($countActive); ?></span>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex justify-content-between align-items-center status-filter-link <?php echo e(request('status') == 'expired' ? 'active fw-bold' : ''); ?>"
                               href="?status=expired">
                                Expired
                                <span class="badge bg-danger text-white ms-2"><?php echo e($countExpired); ?></span>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex justify-content-between align-items-center status-filter-link <?php echo e(request('status') == 'unpaid' ? 'active fw-bold' : ''); ?>"
                               href="?status=unpaid">
                                Unpaid
                                <span class="badge bg-warning text-white ms-2"><?php echo e($countUnpaid); ?></span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <a href="<?php echo e(route('courses.create')); ?>" class="btn btn-primary btn-sm mt-2 mt-md-0">
