            ...
            <div class="card card-custom">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="<?php echo e(route('venues.create')); ?>" class="btn btn-primary">Tambah Venue</a>
                    </div>
                </div>
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(ucfirst($venue->ownership)); ?></td>
                                <td><?php echo e($venue->address); ?></td>
                                <td>
                                    <a href="<?php echo e(route('venues.edit', $venue->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
