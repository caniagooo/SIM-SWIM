        ...
        <div class="row g-2 mb-4">
            ...
            <div class="col-8 col-md-4">
                <select id="filter-type" class="form-select form-select-sm">
                    ...
                    <?php $__currentLoopData = $trainers->pluck('type')->unique(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e(ucfirst($type)); ?>"><?php echo e(ucfirst($type)); ?></option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="<?php echo e($trainer->user->profile_picture ?? asset('assets/media/avatars/default-avatar.png')); ?>" alt="Avatar" class="symbol symbol-30px symbol-circle">
                                            <div>
                                                <div class="fw-semibold text-gray-800"><?php echo e($trainer->user->name); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-start fs-8"><?php echo e($trainer->user->email); ?></td>
                                    <td class="text-start">
                                        <div class="d-flex justify-content-start gap-1">
                                            <a href="<?php echo e(route('trainers.show', $trainer->id)); ?>" class="btn btn-icon btn-sm btn-light-info" title="Detail">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('trainers.edit', $trainer->id)); ?>" class="btn btn-icon btn-sm btn-light-warning" title="Edit">
...
<?php endif; ?><?php /**PATH C:\Users\JITU\swim\resources\views/trainers/index.blade.php ENDPATH**/ ?>