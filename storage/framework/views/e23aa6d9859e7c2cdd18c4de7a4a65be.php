...
<?php $component->withAttributes([]); ?>
    <div class="container mt-5">
        <form id="course-form" method="POST" action="<?php echo e(route('courses.update', $course->id)); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="card card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <a href="<?php echo e(route('courses.show', $course->id)); ?>" class="btn btn-light-primary btn-sm">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="d-flex gap-3">
                                        <input type="hidden" name="type" id="type" value="<?php echo e(old('type', $course->type)); ?>">
                                        <div class="card course-type-card border-primary position-relative" data-type="private" style="cursor:pointer; min-width:200px;">
                                            <div class="position-absolute top-0 end-0 m-2 z-index-2">
                                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                    <input class="form-check-input course-type-checkbox" type="checkbox" id="type-private-checkbox" value="private" disabled <?php echo e(old('type', $course->type) == 'private' ? 'checked' : ''); ?>>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card course-type-card position-relative" data-type="group" style="cursor:pointer; min-width:200px;">
                                            <div class="position-absolute top-0 end-0 m-2 z-index-2">
                                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                    <input class="form-check-input course-type-checkbox" type="checkbox" id="type-group-checkbox" value="group" disabled <?php echo e(old('type', $course->type) == 'group' ? 'checked' : ''); ?>>
                                                </div>
                                            </div>
                                            <div class="card-body text-center py-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea name="basic_skills" id="basic_skills" class="form-control" rows="4"><?php echo e(old('basic_skills', $course->basic_skills)); ?></textarea>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div id="students-section">
                                    <!-- Private: Dropdown -->
                                    <div id="students-dropdown-section" style="<?php echo e(old('type', $course->type) == 'private' ? '' : 'display:none;'); ?>">
                                        <select class="form-select" name="students[]" id="student-private-dropdown">
                                            ...
                                            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                ?>
                                                <option value="<?php echo e($student->id); ?>" <?php echo e(in_array($student->id, old('students', $course->students->pluck('id')->toArray())) ? 'selected' : ''); ?>>
                                                    <?php echo e($student->user->name); ?> | <?php echo e($student->user->email); ?> | <span class="text-muted">(<?php echo e($age); ?> tahun)</span>
                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    ...
                                    <div id="students-table-section" style="<?php echo e(old('type', $course->type) == 'group' ? '' : 'display:none;'); ?>">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" class="student-checkbox"
                                                                    ...
                                                                    <?php echo e(in_array($student->id, old('students', $course->students->pluck('id')->toArray())) ? 'checked' : ''); ?>>
                                                            </td>
                        ...
                        <div class="tab-pane fade" id="step2" role="tabpanel" aria-labelledby="step2-tab">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <select name="venue_id" id="venue_id" class="form-select" required>
                                        ...
                                        <?php $__currentLoopData = $venues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($venue->id); ?>" <?php echo e(old('venue_id', $course->venue_id) == $venue->id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" min="0" name="price" id="price" class="form-control" value="<?php echo e(old('price', $course->price)); ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row g-4 mt-1">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" min="1" name="max_sessions" id="max_sessions" class="form-control" value="<?php echo e(old('max_sessions', $course->max_sessions)); ?>" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" min="1" name="duration_days" id="duration_days" class="form-control" value="<?php echo e(old('duration_days', $course->duration_days)); ?>" required>
                            ...
                            <div class="row g-4 mt-1">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="start_date" id="start_date" class="form-control" value="<?php echo e(old('start_date', $course->start_date ? $course->start_date->format('Y-m-d') : '')); ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="valid_until" class="form-label fw-semibold">Tanggal Berakhir</label>
                                    <input type="date" name="valid_until" id="valid_until" class="form-control" value="<?php echo e(old('valid_until', $course->valid_until ? $course->valid_until->format('Y-m-d') : '')); ?>" readonly>
                                </div>
                            </div>
                            <script>
                                document.addEventListener('DOMContentLoaded', function () {
                                                            ...
                                                            <div class="position-absolute top-0 end-0 m-2 z-index-2">
                                                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                                    <input class="form-check-input trainer-checkbox" type="checkbox" name="trainers[]" value="<?php echo e($trainer->id); ?>" id="trainer-<?php echo e($trainer->id); ?>"
                                                                        <?php echo e(in_array($trainer->id, old('trainers', $course->trainers->pluck('id')->toArray())) ? 'checked' : ''); ?>>
                                                                </div>
                                                            </div>
                                                                                ...
                                                                                <div class="d-flex justify-content-center">
                                                                                    <div class="form-check form-check-sm form-check-custom form-check-solid ms-2">
                                                                                        <input class="form-check-input material-checkbox" type="checkbox" name="materials[]" value="<?php echo e($material->id); ?>" data-estimated-sessions="<?php echo e($material->estimated_sessions ?? 0); ?>" data-min-score="<?php echo e($material->minimum_score ?? 0); ?>"
                                                                                            <?php echo e(in_array($material->id, old('materials', $course->materials->pluck('id')->toArray())) ? 'checked' : ''); ?>>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            <td>
...
</script><?php /**PATH C:\Users\JITU\swim\resources\views\courses\edit.blade.php ENDPATH**/ ?>