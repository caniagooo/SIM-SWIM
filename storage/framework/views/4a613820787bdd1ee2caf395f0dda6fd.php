...
<?php $component->withAttributes([]); ?>
    ...
    <?php echo $__env->make('pages/apps/user-management/users/modals/_update-details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end::Modal - Update user details-->
    <!--begin::Modal - Add schedule-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_add-schedule', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end::Modal - Add schedule-->
    <!--begin::Modal - Add one time password-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_add-one-time-password', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end::Modal - Add one time password-->
    <!--begin::Modal - Update email-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_update-email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end::Modal - Update email-->
    <!--begin::Modal - Update password-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_update-password', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end::Modal - Update password-->
    <!--begin::Modal - Update role-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_update-role', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end::Modal - Update role-->
    <!--begin::Modal - Add auth app-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_add-auth-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end::Modal - Add auth app-->
    <!--begin::Modal - Add task-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_add-task', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end::Modal - Add task-->
    <!--end::Modals-->
...
<?php endif; ?>
<?php /**PATH C:\Users\JITU\swim\resources\views\pages\apps\user-management\users\show.blade.php ENDPATH**/ ?>