                    ...
                    <div class="col-12 col-md-4">
                        <div class="card border-0 shadow-sm h-100 bg-light-primary">
                            <div class="card-body text-center py-4">
                                ...
                                <div class="fs-3 fw-bold text-primary">{{ $stats['last_month'] ?? 0 }}</div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="card border-0 shadow-sm h-100 bg-light-success">
                            <div class="card-body text-center py-4">
                                ...
                                <div class="fs-3 fw-bold text-success">{{ $stats['this_month'] ?? 0 }}</div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="card border-0 shadow-sm h-100 bg-light-info">
                            <div class="card-body text-center py-4">
                                ...
                                <div class="fs-3 fw-bold text-info">{{ $stats['next_month'] ?? 0 }}</div>
